...
store.dispatch(Store.addHypothesis({ id: "1", description: "This is hypothesis 1", evidence: [{ id: "1", description: "This is description 4", db: 2 }], weight: 0 }))
store.dispatch(Store.addHypothesis({ id: "2", description: "This is hypothesis 2", evidence: [{ id: "2", description: "This is description 4", db: -4}, { id: "3", description: "This is description 3", db: 1 }], weight: 0 }))
